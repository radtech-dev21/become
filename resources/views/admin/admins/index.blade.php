@extends('layouts.vertical', ['title' => 'Admins'])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="{{ url('admin/admins/create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add New Admin</a>
                        </div>
                        <div class="col-sm-8">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-user">
                                        ...
                                        <a href="{{ url('admin/admins').'/'. $user->id }}" target="__blank" class="text-body font-weight-semibold">{{ $user->name }}</a>
                                    </td>
                                    <td>{{ $user->phone }}</td>
                                    <td>
                                        {{ $user->email }}
