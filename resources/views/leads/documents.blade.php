            ...
            <div class="modal-body">
                <div class="card">
                   ...
                   <div class="card-body">
                    ...
                    <br>
                    <object id="pdf_viewer" data="" type="application/pdf" height="200px" width="200px">
...
<script type="text/javascript">
    ...
    let storage_url = "{{ Storage::disk('public')->url('uploads/') }}";
    $(document).ready(function() {
        ...
        $(".upload_docs_btn").click(function(){
          ...
          $("#pdf_viewer").attr('data',storage_url+that.data('filename'));
